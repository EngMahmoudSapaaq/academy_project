...
//------------------------------------------
$advertisments = mysqli_query($conn, "SELECT * FROM `advertisments` ") or die('Query failed: ' . mysqli_error($conn));
?>
<!DOCTYPE html>
<html lang="ar" dir="rtl">
    ...
    <body id="page-top">
        ...
        <section class="page-section mt-5 d-flex justify-content-center align-items-center" style="min-height: 100vh;" id="services">
            <div class="container px-4 px-lg-5">
                <h2 class="text-center mt-0">الاعلانات</h2>
                <hr class="divider" />
                <div class="row gx-4 gx-lg-5 justify-content-center align-items-center">
                    <div class="col-12 text-center">
                        <ul class="list-group list-group-flush p-0 gap-2">

                            <?php
                            if (isset($advertisments) && mysqli_num_rows($advertisments) > 0) {
                                while ($advertisment = mysqli_fetch_assoc($advertisments)) {
                                    $academic_id = $advertisment['academic_id'];
                                    ...
                                    echo '<li class="list-group-item py-3 bg-primary text-light">
                                <h5 class="text-end small">المشرف: أ/ '.$academic_admin['name'].'</h5>
                                <div class="row justify-content-between">
                                    <h5 class="col-10 text-end">'.$advertisment['ads'].'</h5>
                                    <div class="col-2 p-0">'.$advertisment['date'].'</div>
                                </div>
                            </li>';
                                }
                            } else {
                                echo '<li class="list-group-item py-3 bg-primary text-light">
                                <h5 class="text-end small">--</h5>
                                <div class="row justify-content-between">
                                    <h5 class="col-10 text-end">لا يوجد اعلانات متوفرة</h5>
