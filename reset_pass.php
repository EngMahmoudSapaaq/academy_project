        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline" style="text-align: right !important;">
                    <form action="reset-conn1.php" method="post" id="form" style="background-color: rgba(255, 255, 255, .1);" class="form p-5 rounded border border-primary">

                        <div>
                            <label for="code" class="text-light col-form-label">الكود المرسل للبريد الالكتروني *</label>
                            <input type="text" class="form-control" id="code" name="code" required>
                        </div>

                        <div>
                            <label for="password" class="text-light col-form-label">كلمة المرور الجديدة *</label>
                            <input type="password" class="form-control" name="password" id="password" required>
                        </div>

                        <div>
                            <label for="password_confirmation" class="text-light col-form-label">تأكيد كلمة المرور *</label>
