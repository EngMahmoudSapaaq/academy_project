...
<div id="layout-wrapper">
    ...
    // جلب البيانات من جدول student_registeration_requests للحالة "pending"
    $sql = $con->prepare("SELECT * FROM student_registeration_requests WHERE status = 'pending'");      
    $sql->execute();
    $rows = $sql->fetchAll();
    ...
    <tr>
        ...
        <td><?php echo $pat['phone_number']; ?></td>
        ...
        <?php } ?>
        <td>
            <a href="accept_student.php?account_id=<?php echo $pat['id']; ?>" class="btn btn-success" onclick="return confirm('هل تريد الموافقة على الحساب؟')"><i class="fa fa-check"></i></a>
        </td>
    </tr>
    <?php } ?>     
</tbody>
