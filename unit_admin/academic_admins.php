                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('هل أنت متأكد من عملية الحذف ؟');" href="delete_acad.php?acad_id=<?php echo $pat['id']; ?>&account_id=<?php echo $pat['account_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>    
