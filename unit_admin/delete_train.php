                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item active">ادارة المشرفين الميدانيين</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h4 class="card-title">كل المشرفين الميدانيين</h4>
                                    <div>
                                        <a href="training_admins_create.php" class="btn btn-success"><i class="fa fa-plus"></i> اضافة مشرف ميداني</a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                       ...
                                       <?php
                                        ...
                                        $stmt = $con->prepare("DELETE FROM training_admins WHERE id = :train_id");
                                        ...
                                        <div class="alert alert-danger role="alert" style="color:#FFF;text-align:center;margin-bottom:40px;font-family:cairo">
                                            تم حذف هذا المشرف الميداني بنجاح
                                        </div>
                                        </div>';    
                                        $sql = $con->prepare("SELECT training_admins.* , accounts.username FROM training_admins INNER JOIN accounts ON accounts.id=training_admins.account_id");      
                                        $sql->execute();
                                        $rows = $sql->fetchAll();
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td>
                                                <a href="training_admins_edit.php?train_id=<?php echo $pat['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('هل أنت متأكد من عملية الحذف ؟');" href="delete_train.php?train_id=<?php echo $pat['id']; ?>&account_id=<?php echo $pat['account_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
