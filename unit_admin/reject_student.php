        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="../index.php" type="button" class="btn btn-danger">تسجيل خروج</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item active">معالجة طلبات الطلاب</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h4 class="card-title">معالجة طلبات الطلاب</h4>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        $stmt->execute(array('rejected' , $account_id));
                                        ...
                                        echo '<div class="container" dir="rtl" style="margin-top:30px;color:#FFF;margin-bottom:30px;font-family:cairo">
                                                  <div class="alert alert-success role="alert" style="color:#FFF;text-align:center;margin-bottom:40px;font-family:cairo">
                                                      تم رفض هذا الطالب بنجاح
                                                  </div>
                                              </div>';    
                                        $sql = $con->prepare("SELECT students.* , accounts.username FROM students INNER JOIN accounts ON accounts.id=students.account_id WHERE accounts.status='pending'");      
                                        $sql->execute();
                                        $rows = $sql->fetchAll();
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                             <td>
                                                <a href="accept_student.php?account_id=<?php echo $pat['account_id']; ?>" class="btn btn-success" onclick="return confirm('هل تريد الموافقة على الحساب؟')"><i class="fa fa-check"></i></a>
                                                <a href="reject_student.php?account_id=<?php echo $pat['account_id']; ?>" onclick="return confirm('هل تريد رفض الطالب ؟');" class="btn btn-danger" onclick="return confirm('هل تريد رفض الحساب؟')"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>     
