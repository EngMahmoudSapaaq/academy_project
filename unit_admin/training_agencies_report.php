                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">تقرير الجهات التدريبية</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h4 class="card-title">تقرير الجهات التدريبية</h4>
                                </div>
 ...
 <div class="table-responsive">
    <table class="table table-centered table-nowrap mb-0">
        ...
        <tr>
            ...
            <th>العنوان</th>
            <th>عدد الفرص</th>
			<th>عدد الطلاب</th> <!-- إضافة عنوان عدد الطلاب -->
            <th>التقييم (متوسط)</th> <!-- تعديل العنوان -->
        ...
        $sql = $con->prepare("
            SELECT 
                training_agencies.*, 
                COALESCE(AVG(students.entity_evaluation), 0) as average_rating,
                COUNT(students.id) as student_count
            FROM 
                training_agencies 
            LEFT JOIN 
                students ON students.training_agency_id = training_agencies.id
            GROUP BY 
                training_agencies.id
        ");      
        $sql->execute();
        $rows = $sql->fetchAll();
        ...
        <tr>
			...
			<td><?php echo $pat['student_count']; ?></td> <!-- عرض عدد الطلاب -->
            <td><?php echo number_format($pat['average_rating'], 1); ?></td> <!-- عرض المتوسط كعدد -->
