                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item active">ادارة الطلاب</li>
                                </ol>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div>
                                        <a href="student_create.php" class="btn btn-success"><i class="fa fa-plus"></i> اضافة طالب</a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        $stmt = $con->prepare("DELETE FROM students WHERE id = :student_id");
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td>
                                                <a href="student_edit.php?student_id=<?php echo $pat['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('هل أنت متأكد من عملية الحذف ؟');" href="delete_student.php?student_id=<?php echo $pat['id']; ?>&account_id=<?php echo $pat['account_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
