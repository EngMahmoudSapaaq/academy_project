...
<tbody>
    ...
    $sql = $con->prepare("
        ...
        JOIN 
            accounts 
        ON 
            accounts.id = students.account_id
    ");      
    $sql->execute();
    $rows = $sql->fetchAll();
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="return confirm('هل أنت متأكد من عملية الحذف؟');" 
               href="delete_student.php?student_id=<?php echo $pat['id']; ?>&account_id=<?php echo $pat['account_id']; ?>" 
